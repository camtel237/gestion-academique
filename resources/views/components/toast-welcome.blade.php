{{-- resources/views/components/toast-welcome.blade.php --}}
{{-- Popup en haut à droite, affiché une fois puis auto-masqué. --}}
@if(session('welcome_toast') || session('goodbye_toast'))
    <div id="authToast"
        ...
        @if(session('welcome_toast'))
            ...
            <div>
                <p class="text-sm font-semibold text-slate-800">Bienvenue, {{ session('welcome_toast') }} !</p>
