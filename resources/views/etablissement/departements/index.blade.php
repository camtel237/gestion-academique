...
<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-5">
    <div class="relative max-w-sm flex-1">
        <form method="GET" action="{{ route('departements.index') }}" id="search-form-departements">
                ...
                <tr class="hover:bg-slate-50 transition">
                    ...
                    <td class="px-4 py-3 text-right whitespace-nowrap">
                        ...
                        <form action="{{ route('departements.destroy', $departement) }}" method="POST" class="inline">
                            @csrf
                            @method('DELETE')
                            <button type="button" onclick="askDeleteConfirm(this.closest('form'), 'Supprimer {{ $departement->libelle }} ?')"
