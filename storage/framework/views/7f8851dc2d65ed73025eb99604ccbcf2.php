<?php $__env->startSection('title', 'Nouveau semestre - EduManager'); ?>
...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-2xl p-6 border border-slate-100 shadow-sm">
        ...
        <form action="<?php echo e(route('semestres.store')); ?>" method="POST" class="space-y-4">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                    ...
                    <?php $__currentLoopData = $niveaux; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $niveau): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($niveau->id); ?>" <?php echo e(old('niveau_id') == $niveau->id ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\gestion-academique\resources\views/etablissement/semestres/create.blade.php ENDPATH**/ ?>