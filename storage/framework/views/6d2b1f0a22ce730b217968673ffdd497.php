<?php $__env->startSection('title', 'Nouvelle année académique - EduManager'); ?>
...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-2xl p-6 border border-slate-100 shadow-sm">
        <form action="<?php echo e(route('annees-academiques.store')); ?>" method="POST" class="space-y-4">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="grid sm:grid-cols-2 gap-3">
                <div>
                    ...
                    <input type="date" name="date_debut" value="<?php echo e(old('date_debut')); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="date" name="date_fin" value="<?php echo e(old('date_fin')); ?>"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="number" name="note_validation" value="<?php echo e(old('note_validation', 10)); ?>" step="0.5" min="0" max="20"
...
unset($__errorArgs, $__bag); ?>"
                          placeholder="Description de l'année académique..."><?php echo e(old('description')); ?></textarea>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\gestion-academique\resources\views/etablissement/annees/create.blade.php ENDPATH**/ ?>