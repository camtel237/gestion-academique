<?php $__env->startSection('title', 'Détails inscription - EduManager'); ?>
    ...
    <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <div class="flex items-center gap-3">
                        <h3 class="text-xl font-bold text-slate-800">Inscription #<?php echo e($inscription->id); ?></h3>
                    ...
                    <p class="text-sm text-slate-500 mt-1">
                        <?php echo e($inscription->etudiant->nom_complet ?? 'N/A'); ?> • <?php echo e($inscription->etudiant->matricule ?? 'N/A'); ?>

                    </p>
                </div>
                <div class="flex gap-2">
                    <a href="<?php echo e(route('inscriptions.edit', $inscription)); ?>"
            ...
            <div class="grid sm:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <p class="text-slate-800 font-medium mt-1">
                        <a href="<?php echo e(route('etudiants.show', $inscription->etudiant)); ?>" class="text-brand-600 hover:underline">
                            <?php echo e($inscription->etudiant->nom_complet ?? 'N/A'); ?>
                ...
                <div>
                    ...
                    <p class="text-slate-800 font-medium mt-1"><?php echo e($inscription->etudiant->matricule ?? 'N/A'); ?></p>
                </div>
                
                <!-- Année académique -->
                <div>
                    <label class="text-xs font-semibold text-slate-500 uppercase tracking-wider">Année académique</label>
                    <p class="text-slate-800 font-medium mt-1"><?php echo e($inscription->anneeAcademique->libelle ?? 'N/A'); ?></p>
                </div>
                
                <!-- Département -->
                <div>
                    <label class="text-xs font-semibold text-slate-500 uppercase tracking-wider">Département</label>
                    <p class="text-slate-800 font-medium mt-1"><?php echo e($inscription->departement->libelle ?? 'N/A'); ?></p>
                </div>
                
                <!-- Spécialité -->
                <div>
                    <label class="text-xs font-semibold text-slate-500 uppercase tracking-wider">Spécialité</label>
                    <p class="text-slate-800 font-medium mt-1"><?php echo e($inscription->specialite->libelle ?? 'N/A'); ?></p>
                </div>
                
                <!-- Niveau -->
                <div>
                    <label class="text-xs font-semibold text-slate-500 uppercase tracking-wider">Niveau</label>
                    <p class="text-slate-800 font-medium mt-1"><?php echo e($inscription->niveau->libelle ?? 'N/A'); ?></p>
                </div>
                
                <!-- Date d'inscription -->
                <div>
                    <label class="text-xs font-semibold text-slate-500 uppercase tracking-wider">Date d'inscription</label>
                    <p class="text-slate-800 font-medium mt-1"><?php echo e($inscription->date_inscription?->format('d/m/Y H:i') ?? 'N/A'); ?></p>
                </div>
                ...
                <div class="sm:col-span-2">
                    ...
                    <p class="text-slate-800 mt-1"><?php echo e($inscription->commentaire ?? 'Aucun commentaire'); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="p-6 bg-slate-50 border-t border-slate-100 flex flex-wrap gap-2">
            ...
            <?php if($inscription->statut === 'en_attente'): ?>
                <form action="<?php echo e(route('inscriptions.valider', $inscription)); ?>" method="POST" class="inline">
                    <?php echo csrf_field(); ?>
                ...
                <form action="<?php echo e(route('inscriptions.annuler', $inscription)); ?>" method="POST" class="inline">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PATCH'); ?>
                    <button type="submit"
            ...
            <form action="<?php echo e(route('inscriptions.destroy', $inscription)); ?>" method="POST" class="inline">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\horta-christ\Downloads\Nouveau dossier (3)\gestion-academique\resources\views/inscriptions/show.blade.php ENDPATH**/ ?>