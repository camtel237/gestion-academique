        ...
        <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="space-y-0.5 mt-1 pl-1">
                            <?php $__currentLoopData = $menu['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e(route($item['route'])); ?>"
                                   class="sidebar-link flex items-center gap-3 px-3 py-2 rounded-lg text-white/80 hover:bg-white/10 hover:text-white transition font-medium text-xs sm:text-sm <?php echo e($currentRoute === $item['route'] ? 'active' : ''); ?>">
                                    <i class="fa-solid <?php echo e($item['icon']); ?> w-5 text-center text-sm"></i>
            ...
            <?php else: ?>
                <a href="<?php echo e(route($menu['route'])); ?>"
                   class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-white/80 hover:bg-white/10 hover:text-white transition font-medium text-xs sm:text-sm <?php echo e($currentRoute === $menu['route'] ? 'active' : ''); ?>">
                    <i class="fa-solid <?php echo e($menu['icon']); ?> w-5 text-center text-sm"></i>
                    <span class="truncate"><?php echo e($menu['label']); ?></span>
                </a>
            <?php endif; ?>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </nav>
    ...
    <div class="p-4 border-t border-white/10 shrink-0 bg-black/10">
        <div class="flex items-center gap-3">
            ...
            <div class="min-w-0 flex-1">
                <div class="text-white text-sm font-semibold truncate leading-tight"><?php echo e(auth()->user()->name ?? 'Admin'); ?></div>
...
<!-- Backdrop Mobile -->
<div id="sidebarBackdrop" onclick="toggleSidebar()" class="hidden fixed inset-0 bg-slate-900/50 backdrop-blur-sm z-30 lg:hidden"></div><?php /**PATH D:\gestion-academique\resources\views/components/sidebar.blade.php ENDPATH**/ ?>