            ...
            <div>
                ...
                <select name="annee_academique_id" id="annee_select"
                    ...
                    <?php $__currentLoopData = $annees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $annee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($annee->id); ?>" <?php echo e($selectedAnnee == $annee->id ? 'selected' : ''); ?>>
            ...
            <div>
                ...
                <select name="niveau_id" id="niveau_select"
                    ...
                    <?php $__currentLoopData = $niveaux; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $niveau): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($niveau->id); ?>" <?php echo e($selectedNiveau == $niveau->id ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\horta-christ\Downloads\Nouveau dossier (3)\gestion-academique\resources\views/notes/create.blade.php ENDPATH**/ ?>