<?php $__env->startSection('title', 'Détails niveau - EduManager'); ?>
            ...
            <div class="flex items-center justify-between">
                <div>
                    <div class="flex items-center gap-3">
                        <h3 class="text-xl font-bold text-slate-800"><?php echo e($niveau->libelle); ?></h3>
                    ...
                    <p class="text-sm text-slate-500 mt-1">
                        <?php echo e($niveau->specialite->libelle ?? '-'); ?> • <?php echo e($niveau->anneeAcademique->libelle ?? '-'); ?>
        ...
        <div class="p-6 space-y-4">
            <div class="grid sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <p class="text-slate-800 font-medium mt-1"><?php echo e($niveau->libelle); ?></p>
                </div>
                <div>
                    <label class="text-xs font-semibold text-slate-500 uppercase tracking-wider">Département</label>
                    <p class="text-slate-800 font-medium mt-1"><?php echo e($niveau->departement->libelle ?? '-'); ?></p>
                </div>
                <div>
                    <label class="text-xs font-semibold text-slate-500 uppercase tracking-wider">Spécialité</label>
                    <p class="text-slate-800 font-medium mt-1"><?php echo e($niveau->specialite->libelle ?? '-'); ?></p>
                </div>
                <div>
                    <label class="text-xs font-semibold text-slate-500 uppercase tracking-wider">Année académique</label>
                    <p class="text-slate-800 font-medium mt-1"><?php echo e($niveau->anneeAcademique->libelle ?? '-'); ?></p>
                </div>
                <div>
            ...
            <div class="pt-4 border-t border-slate-100">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 gap-3">
                    <div class="bg-slate-50 rounded-xl p-3 text-center">
                        <div class="text-2xl font-bold text-brand-600"><?php echo e($niveau->unitesEnseignement->count()); ?></div>
                        <div class="text-xs text-slate-500">Unités d'enseignement</div>
                    </div>
                    <div class="bg-slate-50 rounded-xl p-3 text-center">
                        <div class="text-2xl font-bold text-brand-600"><?php echo e($niveau->matieres->count()); ?></div>
                        <div class="text-xs text-slate-500">Matières</div>
                    </div>
                    <div class="bg-slate-50 rounded-xl p-3 text-center">
                        <div class="text-2xl font-bold text-brand-600"><?php echo e($niveau->semestres->count()); ?></div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\gestion-academique\resources\views/etablissement/niveaux/show.blade.php ENDPATH**/ ?>