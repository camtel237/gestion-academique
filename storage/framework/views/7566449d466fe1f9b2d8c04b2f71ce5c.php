                ...
                <tr class="hover:bg-slate-50 transition">
                    ...
                    <td class="px-4 py-3 text-right whitespace-nowrap">
                        ...
                        <form action="<?php echo e(route('semestres.destroy', $semestre)); ?>" method="POST" class="inline">
                           ...
                           <button type="button"
            onclick="askDeleteConfirm(this.closest('form'), 'Supprimer le semestre <?php echo e($semestre->libelle); ?> ?')"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\gestion-academique\resources\views/etablissement/semestres/index.blade.php ENDPATH**/ ?>