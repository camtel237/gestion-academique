    ...
    $menus = [
        ...
        ['group' => 'Étudiants', 'items' => [
          ...
          ['group' => 'Notes', 'items' => [  // ✅ NOUVEAU GROUPE NOTES
            ...
            ['id' => 'certificats', 'icon' => 'fa-file-lines', 'label' => 'Certificats de scolarité', 'route' => 'certificats.index'],
            ['id' => 'releves', 'icon' => 'fa-table-list', 'label' => 'Relevés de notes', 'route' => 'releves.index'],
        ]],
    ...
    <nav class="flex-1 overflow-y-auto scrollbar-thin p-3 space-y-1 text-sm">
        <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if(isset($menu['group'])): ?>
                <details class="sidebar-group mb-1" open>
                    <summary class="px-3 py-2 text-[11px] uppercase tracking-wider text-white/80 font-semibold flex items-center justify-between cursor-pointer hover:text-white transition">
                        ...
                        <i class="fa-solid fa-chevron-right chev text-[10px]"></i>
                    </summary>
...
<?php /**PATH C:\Users\horta-christ\Downloads\Nouveau dossier (3)\gestion-academique\resources\views/components/sidebar.blade.php ENDPATH**/ ?>