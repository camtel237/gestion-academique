...
<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-5">
    <div class="relative max-w-sm flex-1">
        <form method="GET" action="<?php echo e(route('annees-academiques.index')); ?>" id="search-form-annees">
            <i class="fa-solid fa-magnifying-glass absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 pointer-events-none"></i>
            <input type="text" name="search" id="search-input-annees"
                ...
                <tr class="hover:bg-slate-50 transition">
                    ...
                    <td class="px-4 py-3 text-right whitespace-nowrap">
                        ...
                        <form action="<?php echo e(route('annees-academiques.destroy', $annee)); ?>" method="POST" class="inline">
                            ...
                            <button type="button" onclick="askDeleteConfirm(this.closest('form'), 'Supprimer l\'année académique <?php echo e($annee->libelle); ?> ?')"
...
const searchInputAnnees = document.getElementById('search-input-annees');
if (searchInputAnnees) {
    let debounceTimer;
    searchInputAnnees.addEventListener('input', function () {
        clearTimeout(debounceTimer);
        debounceTimer = setTimeout(() => {
            document.getElementById('search-form-annees').submit();
        }, 400);
    });
}
</script>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\gestion-academique\resources\views/etablissement/annees/index.blade.php ENDPATH**/ ?>