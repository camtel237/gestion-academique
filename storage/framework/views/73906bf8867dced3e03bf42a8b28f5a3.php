<?php $__env->startSection('title', 'Nouvelle spécialité - EduManager'); ?>
...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-2xl p-6 border border-slate-100 shadow-sm">
        ...
        <form action="<?php echo e(route('specialites.store')); ?>" method="POST" class="space-y-4">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" name="code" value="<?php echo e(old('code')); ?>"
                       class="w-full px-3 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:border-brand-500 focus:ring-2 focus:ring-brand-100 outline-none transition uppercase <?php $__errorArgs = ['code'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                       placeholder="Ex: GL" maxlength="20" required>
...
unset($__errorArgs, $__bag); ?>
                <p class="text-xs text-slate-400 mt-1">
                    <i class="fa-solid fa-info-circle"></i> Code unique de la spécialité (ex: GL, RT, GC...)
                </p>
            </div>
...
unset($__errorArgs, $__bag); ?>"
                          placeholder="Description de la spécialité..."><?php echo e(old('description')); ?></textarea>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\horta-christ\Downloads\Nouveau dossier (3)\gestion-academique\resources\views/etablissement/specialites/create.blade.php ENDPATH**/ ?>