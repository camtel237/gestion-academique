<?php $__env->startSection('title', 'Modifier inscription - EduManager'); ?>
...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-2xl p-6 border border-slate-100 shadow-sm">
        ...
        <form action="<?php echo e(route('inscriptions.update', $inscription)); ?>" method="POST" class="space-y-4" id="inscriptionForm">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                    ...
                    <?php $__currentLoopData = $etudiants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $etudiant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($etudiant->id); ?>" <?php echo e(old('etudiant_id', $inscription->etudiant_id) == $etudiant->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                    ...
                    <?php $__currentLoopData = $annees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $annee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($annee->id); ?>" <?php echo e(old('annee_academique_id', $inscription->annee_academique_id) == $annee->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                    ...
                    <?php $__currentLoopData = $departements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $departement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($departement->id); ?>" <?php echo e(old('departement_id', $inscription->departement_id) == $departement->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                          placeholder="Informations supplémentaires sur l'inscription..."><?php echo e(old('commentaire', $inscription->commentaire)); ?></textarea>
...
document.addEventListener('DOMContentLoaded', function() {
                    ...
                    if (data.length === 0) {
                        ...
                        data.forEach(specialite => {
                            ...
                            if (selectedId && specialite.id == selectedId) {
                                ...
                                loadNiveaux(specialite.id, "<?php echo e(old('niveau_id', $inscription->niveau_id)); ?>");
                            }
                            specialiteSelect.appendChild(option);
                        });
                    }
    ...
    const initialSpecialite = "<?php echo e(old('specialite_id', $inscription->specialite_id)); ?>";
    const initialNiveau = "<?php echo e(old('niveau_id', $inscription->niveau_id)); ?>";
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\horta-christ\Downloads\Nouveau dossier (3)\gestion-academique\resources\views/inscriptions/edit.blade.php ENDPATH**/ ?>