...
<body>
    <div>
            ...
            <div class="card-body">
                <div class="avatar">
                    <?php if($inscription->etudiant->photo): ?>
                        <img src="<?php echo e(public_path('storage/' . $inscription->etudiant->photo)); ?>" alt="Photo">
                    <?php else: ?>
                ...
                <div class="info">
                    ...
                    <div class="id">Matricule: <?php echo e($inscription->etudiant->matricule); ?></div>
                    <div class="row"><span class="lbl">Niveau</span> <span><?php echo e($inscription->niveau->libelle ?? '-'); ?></span></div>
                    <div class="row"><span class="lbl">Spécialité</span> <span><?php echo e($inscription->specialite->libelle ?? '-'); ?></span></div>
                    <div class="row"><span class="lbl">Département</span> <span><?php echo e($inscription->departement->libelle ?? '-'); ?></span></div>
                </div>
            </div>
            <div class="card-bottom">
                <div>
                    <div class="valid">Valable jusqu'au 31/12/<?php echo e(date('Y')+1); ?></div>
                    <div style="font-size:10px;color:#1a365d;font-weight:600;">N° <?php echo e($inscription->etudiant->matricule); ?></div>
                </div>
        ...
        <div class="actions no-print">
            ...
            <a href="<?php echo e(route('cartes.index')); ?>" class="btn btn-secondary">
...
</html><?php /**PATH C:\Users\horta-christ\Downloads\Nouveau dossier (3)\gestion-academique\resources\views/effets/carte-etudiant.blade.php ENDPATH**/ ?>