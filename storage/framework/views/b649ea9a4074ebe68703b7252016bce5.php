                ...
                <div>
                    ...
                    <div class="relative mt-1">
                        ...
                        <input
                            ...
                            required
                            class="w-full pl-10 pr-3 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:border-brand-500 focus:ring-2 focus:ring-brand-100 outline-none transition <?php $__errorArgs = ['email'];
                ...
                <div>
                    ...
                    <div class="relative mt-1">
                        ...
                        <input
                            ...
                            name="password"
                            required
                            class="w-full pl-10 pr-10 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:border-brand-500 focus:ring-2 focus:ring-brand-100 outline-none transition <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                ...
                <button type="submit" id="loginSubmitBtn" class="w-full grad-blue text-white py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl hover:opacity-95 transition flex items-center justify-center gap-2">
                    <span id="loginSubmitSpinner" class="hidden"><i class="fa-solid fa-spinner fa-spin"></i></span>
                    <span>Connexion</span>
                    <i class="fa-solid fa-arrow-right" id="loginSubmitIcon"></i>
                </button>
            </form>
...
document.querySelector('form[action="<?php echo e(route('login')); ?>"]').addEventListener('submit', function () {
    const btn = document.getElementById('loginSubmitBtn');
    document.getElementById('loginSubmitSpinner').classList.remove('hidden');
    document.getElementById('loginSubmitIcon').classList.add('hidden');
    btn.disabled = true;
});
</script>
<?php echo $__env->make('components.toast-welcome', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

</body>
</html><?php /**PATH D:\gestion-academique\resources\views/auth/login.blade.php ENDPATH**/ ?>