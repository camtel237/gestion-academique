...
<head>
    ...
    <style>
        ...
        .sidebar-group.open .sidebar-group-body {
            /* max-height set inline via JS for a smooth, exact animation */
        }
        #sidebar {
...
<body class="bg-slate-100 text-slate-800 antialiased">
    ...
    <script>
        ...
        // Accordéon fluide pour les groupes du sidebar (remplace le comportement
        // instantané des <details> natifs par une animation de hauteur douce).
        document.addEventListener('DOMContentLoaded', function () {
            document.querySelectorAll('.sidebar-group').forEach(function (group) {
                ...
                // état initial
                setOpenState(group.hasAttribute('open'), false);

                summary.addEventListener('click', function (e) {
                    e.preventDefault();
                    setOpenState(!group.classList.contains('open'), true);
                });
            });
...
</html><?php /**PATH C:\Users\horta-christ\Downloads\Nouveau dossier (3)\gestion-academique\resources\views/layouts/app.blade.php ENDPATH**/ ?>