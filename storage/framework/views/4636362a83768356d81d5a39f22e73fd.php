<?php $__env->startSection('title', 'Nouvel employé - EduManager'); ?>
...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-2xl p-6 border border-slate-100 shadow-sm">
        <form action="<?php echo e(route('personnels.store')); ?>" method="POST" class="space-y-4">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" name="fonction" value="<?php echo e(old('fonction')); ?>"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="grid sm:grid-cols-2 gap-3">
                <div>
                    ...
                    <input type="text" name="diplome" value="<?php echo e(old('diplome')); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="date" name="date_embauche" value="<?php echo e(old('date_embauche')); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\gestion-academique\resources\views/etablissement/personnels/create.blade.php ENDPATH**/ ?>