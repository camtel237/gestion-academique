...
<?php $__env->startSection('title', 'Relevés de notes - EduManager'); ?>

<?php
    $pageTitle = 'Relevés de notes';
    $pageSub = 'Générer les relevés à partir des inscriptions validées';
?>
...
<div class="bg-white rounded-2xl border border-slate-100 overflow-hidden">
    <div class="overflow-x-auto scrollbar-thin">
        <table class="w-full text-sm" id="relevesTable">
            ...
            <tbody class="divide-y divide-slate-100">
                ...
                <tr class="hover:bg-slate-50 transition">
                    ...
                    <td class="px-4 py-3 text-right whitespace-nowrap">
                        <a href="<?php echo e(route('releves.show', $inscription->id)); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\horta-christ\Downloads\Nouveau dossier (3)\gestion-academique\resources\views/effets/releves/index.blade.php ENDPATH**/ ?>