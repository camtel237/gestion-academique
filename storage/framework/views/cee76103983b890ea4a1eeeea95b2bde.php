<?php $__env->startSection('title', 'Unités d\'enseignement - EduManager'); ?>
...
<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-5">
    <div class="flex flex-wrap gap-2 flex-1">
        <div class="relative max-w-sm flex-1 min-w-[200px]">
            ...
            <form method="GET" action="<?php echo e(route('ues.index')); ?>" class="inline">
        ...
        <div class="relative">
            <form method="GET" action="<?php echo e(route('ues.index')); ?>" class="inline">
                ...
                <input type="hidden" name="niveau_id" value="<?php echo e(request('niveau_id')); ?>">
        ...
        <div class="relative">
            <form method="GET" action="<?php echo e(route('ues.index')); ?>" class="inline">
                <input type="hidden" name="search" value="<?php echo e(request('search')); ?>">
                <input type="hidden" name="annee_academique_id" value="<?php echo e(request('annee_academique_id')); ?>">
    ...
    <div class="overflow-x-auto scrollbar-thin">
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-slate-100">
                <?php $__empty_1 = true; $__currentLoopData = $ues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr class="hover:bg-slate-50 transition">
                    <td class="px-4 py-3 font-bold text-brand-700"><?php echo e($ue->code); ?></td>
                    <td class="px-4 py-3"><?php echo e($ue->libelle); ?></td>
                    <td class="px-4 py-3">
                    ...
                    <td class="px-4 py-3">
                        <?php if($ue->semestre): ?>
                            <span class="px-2 py-1 rounded-full bg-amber-50 text-amber-700 text-xs font-semibold">
                                <?php echo e($ue->semestre->libelle); ?>
                    ...
                    <td class="px-4 py-3"><?php echo e($ue->anneeAcademique->libelle ?? '-'); ?></td>
                    <td class="px-4 py-3">
                        <span class="px-2 py-1 rounded-full bg-sky-50 text-sky-700 text-xs font-semibold">
                            <?php echo e($ue->matieres->count()); ?>

                        </span>
                    </td>
                    <td class="px-4 py-3 text-right whitespace-nowrap">
                        <a href="<?php echo e(route('ues.show', $ue)); ?>"
                        ...
                        <a href="<?php echo e(route('ues.edit', $ue)); ?>"
                        ...
                        <form action="<?php echo e(route('ues.destroy', $ue)); ?>" method="POST" class="inline">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('DELETE'); ?>
                            <button type="button"
                                    onclick="askDeleteConfirm(this.closest('form'), 'Supprimer l\'UE <?php echo e($ue->libelle); ?> ?')"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\gestion-academique\resources\views/etablissement/ues/index.blade.php ENDPATH**/ ?>