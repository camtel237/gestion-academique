                ...
                <tr class="hover:bg-slate-50 transition">
                    ...
                    <td class="px-4 py-3 text-right whitespace-nowrap">
                        ...
                        <form action="<?php echo e(route('specialites.destroy', $specialite)); ?>" method="POST" class="inline">
                            ...
                            <button type="button" onclick="askDeleteConfirm(this.closest('form'), 'Supprimer la spécialité <?php echo e($specialite->libelle); ?> ?')"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\gestion-academique\resources\views/etablissement/specialites/index.blade.php ENDPATH**/ ?>