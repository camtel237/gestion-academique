    ...
    <div class="page">
        <div class="content">
            ...
            <table class="champs">
                <tr>
                    <td width="62%">
                        ...
                        <span class="val"><?php echo e(strtoupper($inscription->etudiant->nom . ' ' . $inscription->etudiant->prenom)); ?></span>
                ...
                <tr>
                    <td>
                        ...
                        <span class="val"><?php echo e(strtoupper($inscription->departement->libelle ?? '-')); ?></span>
                ...
                <tr>
                    <td>
                        ...
                        <span class="val"><?php echo e(strtoupper($inscription->specialite->libelle ?? '-')); ?></span>
            ...
            <div class="footer-note">
                Il n'est délivré qu'un seul exemplaire du présent Relevé de notes / Only a unique Transcript shall be issued<br>
                Vérification : <?php echo e(config('etablissement.email_verification', 'infos.iba@univ-douala.com')); ?>
...
</html><?php /**PATH C:\Users\horta-christ\Downloads\Nouveau dossier (3)\gestion-academique\resources\views/effets/releves/pdf.blade.php ENDPATH**/ ?>