<?php $__env->startSection('title', 'Détails matière - EduManager'); ?>
            ...
            <div class="flex items-center justify-between">
                <div>
                    <div class="flex items-center gap-3">
                        <h3 class="text-xl font-bold text-slate-800"><?php echo e($matiere->libelle); ?></h3>
                        <span class="px-2 py-1 rounded-full bg-brand-50 text-brand-700 text-xs font-semibold">
                            <?php echo e($matiere->code); ?>

                        </span>
                    </div>
                    <p class="text-sm text-slate-500 mt-1">
                        <?php echo e($matiere->uniteEnseignement->libelle ?? '-'); ?> • <?php echo e($matiere->semestre->libelle ?? '-'); ?>
        ...
        <div class="p-6 space-y-4">
            <div class="grid sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <p class="text-slate-800 font-medium mt-1"><?php echo e($matiere->code); ?></p>
                </div>
                <div>
                    <label class="text-xs font-semibold text-slate-500 uppercase tracking-wider">Libellé</label>
                    <p class="text-slate-800 font-medium mt-1"><?php echo e($matiere->libelle); ?></p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <p class="text-slate-800 font-medium mt-1">
                        <span class="px-2 py-1 rounded-full text-xs font-semibold <?php echo e($matiere->est_actif ? 'bg-green-100 text-green-700' : 'bg-slate-100 text-slate-600'); ?>">
                            <?php echo e($matiere->est_actif ? 'Actif' : 'Inactif'); ?>
                ...
                <div>
                    ...
                    <p class="text-slate-800 font-medium mt-1"><?php echo e($matiere->departement->libelle ?? '-'); ?></p>
                </div>
                <div>
                    <label class="text-xs font-semibold text-slate-500 uppercase tracking-wider">UE</label>
                    <p class="text-slate-800 font-medium mt-1"><?php echo e($matiere->uniteEnseignement->libelle ?? '-'); ?></p>
                </div>
                <div>
                    <label class="text-xs font-semibold text-slate-500 uppercase tracking-wider">Semestre</label>
                    <p class="text-slate-800 font-medium mt-1"><?php echo e($matiere->semestre->libelle ?? '-'); ?></p>
                </div>
                <div>
                    <label class="text-xs font-semibold text-slate-500 uppercase tracking-wider">Niveau</label>
                    <p class="text-slate-800 font-medium mt-1"><?php echo e($matiere->niveau->libelle ?? '-'); ?></p>
                </div>
                <div>
                    <label class="text-xs font-semibold text-slate-500 uppercase tracking-wider">Enseignant</label>
                    <p class="text-slate-800 font-medium mt-1">
                        <?php if($matiere->personnel): ?>
                            <?php echo e($matiere->personnel->nom_complet); ?>

                            <span class="text-sm text-slate-500 block"><?php echo e($matiere->personnel->matricule); ?></span>
                        <?php else: ?>
            ...
            <div class="pt-4 border-t border-slate-100">
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div class="bg-slate-50 rounded-xl p-3">
                        ...
                        <div class="text-lg font-bold text-brand-600"><?php echo e($matiere->uniteEnseignement->total_credit ?? 0); ?></div>
                    </div>
                    <div class="bg-slate-50 rounded-xl p-3">
                        <div class="text-xs text-slate-500">Somme crédits matières</div>
                        <div class="text-lg font-bold text-brand-600">
                            <?php echo e(\App\Models\Etablissement\Matiere::where('unite_enseignement_id', $matiere->unite_enseignement_id)->sum('credit')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\horta-christ\Downloads\Nouveau dossier (3)\gestion-academique\resources\views/etablissement/matieres/show.blade.php ENDPATH**/ ?>