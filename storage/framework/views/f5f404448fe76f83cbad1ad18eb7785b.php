<?php $__env->startSection('title', 'Modifier département - EduManager'); ?>
...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-2xl p-6 border border-slate-100 shadow-sm">
        <form action="<?php echo e(route('departements.update', $departement)); ?>" method="POST" class="space-y-4">
            <?php echo csrf_field(); ?>
            <?php echo method_field('PUT'); ?>

            <div>
                <label class="text-xs font-semibold text-slate-600 uppercase tracking-wider">Code *</label>
                   <input type="text" value="<?php echo e($departement->code); ?>" disabled class="w-full px-3 py-2.5 bg-slate-100 border border-slate-200 rounded-xl text-slate-500 cursor-not-allowed">

            </div>

            <div>
                <label class="text-xs font-semibold text-slate-600 uppercase tracking-wider">Libellé *</label>
                <input type="text" name="libelle" value="<?php echo e(old('libelle', $departement->libelle)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                          placeholder="Description du département..."><?php echo e(old('description', $departement->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>">
                    ...
                    <?php $__currentLoopData = $personnels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $personnel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($personnel->id); ?>" <?php echo e(old('chef_departement_id', $departement->chef_departement_id) == $personnel->id ? 'selected' : ''); ?>>
            ...
            <div>
                <label class="flex items-center gap-3 text-sm">
                    <input type="checkbox" name="est_actif" value="1"
                           <?php echo e(old('est_actif', $departement->est_actif) ? 'checked' : ''); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\gestion-academique\resources\views/etablissement/departements/edit.blade.php ENDPATH**/ ?>