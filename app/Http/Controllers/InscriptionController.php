...
{
    $query = Inscription::with(['etudiant', 'anneeAcademique', 'departement', 'specialite', 'niveau']);

    // La barre de recherche existait dans la vue mais n'était jamais lue ici —
    // c'est pour ça qu'elle ne faisait rien.
    ...
    $inscriptions = $query->orderBy('created_at', 'desc')->paginate(15)->withQueryString();
    ...
    return view('inscriptions.index', compact('inscriptions', 'specialites', 'niveaux'));
}
